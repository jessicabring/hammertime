...
var craigeNorth = new ResHall(
    "Craige North",35.90379,-79.04604,true, 3,"suite"
)

var hardin = new ResHall(
    "Hardin",35.90417,-79.0461,true, 2,"suite"
)

var horton = new ResHall(
    "Horton",35.90351,-79.04412,true, 4,"suite"
)
...
var ram1 = new ResHall(
    "Ram Village 1",35.9023641,-79.04556226,true ,3,"apartment"
)

var ram2 = new ResHall(
    "Ram Village 2",35.90217201,-79.04699155,false, 2,"apartment"
)

var ram3 = new ResHall(
    "Ram Village 3",35.90276816,-79.04593954,false,2,"apartment"
)

var ram4 = new ResHall(
    "Taylor Hall",35.90168511,-79.04375685,false,2,"apartment"
)

var ram5 = new ResHall(
    "Ram Village 5",35.90186761,-79.04217969,true,3,"apartment"
)
